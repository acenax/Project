            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">เพิ่ม / ลบ / แก้ไข สมาชิก </h4>
            ...
            <div class="">
                <table class="table" id="dataal">
                    ...
                    <tbody>
                        ...
                        <?php
                        $i = 0;
                        $get_user = $con->query("SELECT * FROM `tbluser` WHERE user_type = 'member'");
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" autocomplete="off" class="form-control" name="user_type" value="member" readonly>
                            </div>
                        </div>
                    </div>
            </div>
                ...
                <form id="Edit_Users" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="">ชื่อผู้ใช้งาน</label>
                                <input type="text" autocomplete="off" class="form-control" name="user_username" id="edituser_username">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="">สถานะ</label>
                                <input type="text" autocomplete="off" class="form-control" name="user_type" value="member" id="edituser_type" readonly>
                            </div>
                        </div>
                    </div>
            </div>
        ...
        $.ajax({
            ...
            success: (respons) => {
                ...
                if (res.status == 'success') {
                    ...
                    $("#edituser_type").val(res.msg.user_type);
