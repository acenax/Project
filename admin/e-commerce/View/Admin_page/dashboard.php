...
<div class="content-page">
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-xs-3">
                    <div class="box-content1">
                        ...
                        ?>
                        <h3 style="color: #fff;"><?= $formatted_total ?> บาท</h3>
                ...
                <div class="col-xs-3">
                    <div class="box-content3">
                        ...
                        if ($get_record['tot_record'] > 0) {
                            ...
                            echo "window.location.href = '?PendingProduct';";
                            echo "}";
                            echo "});";
                            echo "</script>";
                        }
                ...
                <div class="col-xs-3">
                    <div class="box-content4">
                        <?php
                        $found_rows = $con->query("SELECT product_id FROM `tblproduct` WHERE (`product_qty` <= `product_min`) AND (`product_status` = '0')")->num_rows;
                        ?>
                        <h3 style="color: #fff;"><?= number_format($found_rows); ?> ชิ้น</h3>
            ...
            <!-- <button id="resetTotal" class="btn btn-danger">กดเพื่อรีเซ็ต</button>
            <span class="reset-comment">กดรีเซ็ตตัวเลขรายได้ทั้งหมด</span> -->
                    ...
                    <div class="card" style="border: 1px solid #ddd; padding: 10px 30px; border-radius: 5px ;">
                        ...
                        <div class="card-body">
                            <table class="table" id="dataal">
                                ...
                                <tbody>
                                    <?php
                                    $get_low_product = $con->query("SELECT * FROM `tblproduct` WHERE (`product_qty` <= `product_min`)  AND (`product_status` = '0')");
...
<script>
    ...
    //     var resetConfirmed = confirm("Are you sure you want to reset the total amount?");

    //     // If the user confirms, reset the total amount to 0
    //     if (resetConfirmed) {
    //         document.querySelector('.box-content1 h3').innerText = "0 บาท";
    //     }
    // });
</script>