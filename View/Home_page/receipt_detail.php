...
<?php
$bill_no = (!empty($_GET['receiptdetail'])) ? $_GET['receiptdetail'] : '';
...
<div class="container mt-5">
    <div class="row">
        <div class="col-12 mb-3">
            <h3 class="text-center">รายละเอียดการรับสินค้า</h3>
            ...
            <div class="body-payment">
                ...
                <?php else : ?>
                    ...
                    <div class="row my-2">
                        <div class="col-4 col-sm-3 col-lg-2">วันที่บันทึกตรวจรับ </div>
                            ...
                            <div class="col-2">
                                <div class="product-image d-flex align-items-center justify-content-center">
                                    <?php if (is_file(sprintf('%s/%s/%s', 'admin', PRODUCT_FILE_DIR, $products[$rec['product_id']]['product_picshow']))) : ?>
                                        <img src="<?php printf('%s/%s/%s', 'admin', PRODUCT_FILE_DIR, $products[$rec['product_id']]['product_picshow']); ?>" alt="<?php echo $products[$rec['product_id']]['product_name']; ?>" class="h-100 w-100">
                                    <?php else : ?>
                                        <img src="<?php printf('%s/%s/%s', 'admin', dirname(PRODUCT_FILE_DIR), 'product-image.png'); ?>" alt="<?php echo $products[$rec['product_id']]['product_name']; ?>" class="h-100 w-100">
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-6">
                                <label><?php echo $products[$rec['product_id']]['product_name']; ?></label> <br>
                                <small class="text-warning"><?php printf('%s %s %s', 'ราคา', number_format($rec['price'], 2), 'บาท'); ?></small>
                            </div>
                    ...
                    <?php else : ?>
                        <div class="row mt-3">
                            <?php foreach ($files as $file) : ?>
                                <div class="col-12 col-md-6 col-lg-4 mt-4 image-wrapper">
                                    <div class="d-flex flex-column border rounded p-2">
                                        <a href="javascript:;" class="btn-browse d-flex justify-content-center" title="ไฟล์แนบ">
                                            <img src="<?php echo site_url(implode('/', ['admin', dirname(PRODUCT_FILE_DIR), 'receipts', $file['file_path']])) ?>" class="w-100" alt="<?php echo $file['file_name']; ?>">
                                        </a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-6 pt-2">
                                    <?php for ($score = 1; $score <= 5; $score++) : ?>
                                        <a href="javascript:;" class="score-vote <?php echo ($score <= (int)$receipt['product_score']) ? 'text-warning' : 'text-muted'; ?>" data-score="<?php echo $score; ?>"><i class="fa fa-star fa-lg"></i></a>
                                    <?php endfor; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 my-2">
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-6 pt-2">
                                    <?php for ($score = 1; $score <= 5; $score++) : ?>
                                        <a href="javascript:;" class="score-vote <?php echo ($score <= (int)$receipt['service_score']) ? 'text-warning' : 'text-muted'; ?>" data-score="<?php echo $score; ?>"><i class="fa fa-star fa-lg"></i></a>
                                    <?php endfor; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 my-2">
                            <div class="form-group row">
                                ...
                                <div class="col-8 col-md-6 pt-2">
                                    <?php for ($score = 1; $score <= 5; $score++) : ?>
                                        <a href="javascript:;" class="score-vote <?php echo ($score <= (int)$receipt['shipping_score']) ? 'text-warning' : 'text-muted'; ?>" data-score="<?php echo $score; ?>"><i class="fa fa-star fa-lg"></i></a>
                                    <?php endfor; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 my-2">
                            <div class="form-group row">
                                <label class="col-12 col-md-3 col-form-label text-start text-md-end">ความเห็นเพิ่มเติม</label>
